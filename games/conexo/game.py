...
from games.conexo.common import ConexoFeedback, ConexoFinalResult, ConexoInfo, ConexoWordGroup
...
class ConexoGame(BaseGame[ConexoInfo, None, set[int], ConexoFeedback, ConexoFinalResult]):
    ...
    def start_game(self) -> ConexoInfo:
        self._found_groups: set[str] = set()
    ...
    def get_final_result(self) -> ConexoFinalResult:
        return ConexoFinalResult(
            num_found=len(self._found_groups),
            groups=[
