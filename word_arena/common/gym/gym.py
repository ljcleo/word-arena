...
from ..config.selector.base import BaseConfigSelector
...
class Gym[MT, UT, CT, IT, GT, FT, RT]:
    def __init__(
        ...
        *,
        ...
        config_selector: BaseConfigSelector[MT, CT],
        ...
        self._config_selector: BaseConfigSelector[MT, CT] = config_selector
    ...
    def _read_config(self) -> CT:
        return self._config_selector(meta_config=self._meta_config)
