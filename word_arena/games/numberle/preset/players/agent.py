...
) -> tuple[NumberleLLMAgentEngine, NumberleLogAgentRenderer]:
    return (
        NumberleLLMAgentEngine(model=model, do_analyze=do_analyze),
        NumberleLogAgentRenderer(agent_log_func=log_func),
    )
