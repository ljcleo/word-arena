...
class ConnectionsInGameFormatter(
    BaseInGameFormatter[ConnectionsInfo, None, ConnectionsGuess, ConnectionsFeedback]
):
    @override
    @classmethod
    def format_game_info(cls, *, game_info: ConnectionsInfo) -> Iterator[tuple[str, str]]:
    ...
    @override
    @classmethod
    def format_hint(cls, *, game_info: ConnectionsInfo, hint: None) -> Iterator[tuple[str, str]]:
        yield from ()

    @override
    @classmethod
    def format_guess(
        cls, *, game_info: ConnectionsInfo, hint: None, guess: ConnectionsGuess
...
class ConnectionsFinalResultFormatter(BaseFinalResultFormatter[ConnectionsFinalResult]):
    @override
    @classmethod
    def format_final_result(
        cls, *, final_result: ConnectionsFinalResult
    ) -> Iterator[tuple[str, str]]:
