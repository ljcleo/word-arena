...
class ContextoAgentMemory(
    ...
    def make_create_experience_prompt(self) -> Iterator[str]:
        yield "Now, initialize some notes about the word similarity laws and possible strategies."

    @override
    def make_update_experience_prompt(self) -> Iterator[str]:
        yield "Now, update your notes about the word similarity laws and possible strategies."
