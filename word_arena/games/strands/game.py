...
class StrandsGame(BaseGame[StrandsInfo, None, StrandsGuess, StrandsFeedback, StrandsFinalResult]):
    ...
    def __init__(self, *, board: list[tuple[str, int]], clue: str, max_guesses: int) -> None:
        super().__init__()
    ...
    def start_game(self) -> StrandsInfo:
        ...
        return StrandsInfo(board=self._2d_board, clue=self._clue, max_guesses=self._max_guesses)
